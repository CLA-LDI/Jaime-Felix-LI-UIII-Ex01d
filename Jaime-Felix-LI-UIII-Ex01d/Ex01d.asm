				TITLE	Programa para evaluar la suma los elementos de un arreglo (sumar pares, restar impares) usando procedimientos
...
Principal		PROC
				...
				; Obtener la suma de los elementos (sumar pares, restar impares) de Arreglo1

				; Llamar al método SumaResta
...
SumaResta		PROC
				...
				; 
				; Ciclo para sumar los elementos del arreglo (sumar pares, restar impares)
